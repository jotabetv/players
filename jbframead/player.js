...
$( '#show').on('click', function(event) {
	...
	document.getElementById("jb_aberta").innerHTML = ('☑ Quantidade: ' + contAberta + ' Canais');
	document.getElementById("jb_cultur").innerHTML = ('☑ Quantidade: ' + contCultur + ' Canais');
	document.getElementById("jb_esport").innerHTML = ('☑ Quantidade: ' + contEsport + ' Canais');
	document.getElementById("jb_filmes").innerHTML = ('☑ Quantidade: ' + contFilmes + ' Canais');
	document.getElementById("jb_globos").innerHTML = ('☑ Quantidade: ' + contGlobos + ' Canais');
	document.getElementById("jb_infant").innerHTML = ('☑ Quantidade: ' + contInfant + ' Canais');
	document.getElementById("jb_notici").innerHTML = ('☑ Quantidade: ' + contNotici + ' Canais');
	document.getElementById("jb_realit").innerHTML = ('☑ Quantidade: ' + contRealit + ' Canais');
	document.getElementById("jb_religi").innerHTML = ('☑ Quantidade: ' + contReligi + ' Canais');
	document.getElementById("jb_varied").innerHTML = ('☑ Quantidade: ' + contVaried + ' Canais');
	document.getElementById("jb_movies").innerHTML = ('☑ Quantidade: ' + contMovies + ' Canais');
