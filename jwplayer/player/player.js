...
const player = jwplayer('player').setup({image: jw.image,mute: false,volume: 85,autostart: true,repeat: false,abouttext: jw.text,aboutlink: jw.link,skin: {active: jw.color
